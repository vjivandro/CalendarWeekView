package com.juris.weekencalendar;
...
import com.juris.weekencalendar.decorator.DayDecorator;
import com.juris.weekencalendar.decorator.DefaultDayDecorator;
import com.juris.weekencalendar.eventbus.BusProvider;
import com.juris.weekencalendar.eventbus.Event;
...
import com.juris.weekencalendar.view.WeekPager;
...
public class WeekCalendar extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            int selectedDateColor = typedArray.getColor(R.styleable.WeekCalendar_selectedBgColor, ContextCompat.getColor(getContext(), R
                    .color.colorBlueDark));
        ...
        daysName.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                switch (days[position]) {
                    case "Mon": namaHari = "SEN"; break;
                    case "Tue": namaHari = "SEL"; break;
                    case "Wed": namaHari = "RAB"; break;
                    case "Thu": namaHari = "KAM"; break;
                    case "Fri": namaHari = "JUM"; break;
